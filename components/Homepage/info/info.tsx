    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          <br />
          I thrive in fast-paced environments, shipping production-grade systems. Ultimately, I bridge the gap between complex AI pipelines and seamless user experiences, building end-to-end architectures that are secure, highly available, and optimized for scale.
        </p>
        <div
          style={{
            width: "100%",
